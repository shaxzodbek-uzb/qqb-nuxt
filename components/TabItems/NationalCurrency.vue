<template>
  <div class="tab-content-national-currency">
    ...
    <div class="card-items-container d-flex f-wrap">
      <router-link to="/" class="card-items deposit-card rounded transition">
